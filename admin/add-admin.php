...
?>
<button id="show_sidebar_btn" class="sidebar_toggle" hidden><i class="uil uil-angle-right-b"></i></button>
<button id="hide_sidebar_btn" class="sidebar_toggle" hidden><i class="uil uil-angle-left-b"></i></button>
<section class="form_section">
    <div class="container form_section-container">
        ...
        <form action="<?= ROOT_URL ?>php/add-admin-logic.php" enctype="multipart/form-data" method="POST">
            ...
            <div class="control">
                <a href="<?= ROOT_URL ?>/admin/manage-admin.php" class="btn-lg">Back</a>
                <button type="Submit" name="submit" class="btn-lg"> Add New Admin</button>
            </div>
        </form>
    </div>
</section>
