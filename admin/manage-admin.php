                    ...
                    <?php if (mysqli_num_rows($admins) > 0) : ?>
                        <?php while ($admin = mysqli_fetch_assoc($admins)) : ?>
                            <tr>
                                ...
                                <td><button id="<?= $admin['id'] ?>" name="edit-btn" class="edit-course edt-adminBtn">Edit</button></td>
                                <td><a onclick="validate(this)" href="<?= ROOT_URL ?>php/delete-admin.php?id=<?= $admin['id'] ?>" class="btn sm danger">Delete</a></td>
                            </tr>
                        <?php endwhile ?>
                    <?php else :  ?>
                        <tr>
...
<!-- ******************** End OF MANAGE ADMIN SECTION *********************** -->


<div id="modal-edit-inactive3"></div>
<div id="modal-edit-admin">
    <section class="form_section">
        <div class="container form_section-container">
            ...
            <form id="edit-admin-form" enctype="multipart/form-data">
                ...
                <input type="hidden" id="admin_id" name="id" value="" placeholder="Subject Title">
                <input type="hidden" id="prev_avatar" name="prev_avatar_name" value="" placeholder="Previous avatar">
                <input type="hidden" id="prev_password" name="prev_password" value="" placeholder="Create New Password">

                <div class="control">
                    <input type="text" id="admin_fname" name="firstname" value="" placeholder="First Name">
                    <input type="text" id="admin_lname" name="lastname" value="" placeholder="Last Name">
                </div>
                ...
                <input type="text" id="pnumber" name="pnumber" value="" placeholder="NIRC/Passport Number">
                ...
                <div class="control">
                    <button type="" name="cancel" id="cancel" class="btn-lg">Cancel</button>
                    <button type="submit" name="submit" id="update" class="btn-lg">Update Admin</button>
                </div>
            </form>
        </div>
    </section>
