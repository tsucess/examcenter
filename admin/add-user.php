...
// get back form data if there was registeration error
...
$passport = $_SESSION['signup-data']['passport'] ?? null;
...
<section class="form_section">
    <div class="container form_section-container">
        ...
        <form action="<?= ROOT_URL ?>php/add-user-logic.php" enctype="multipart/form-data" method="POST">
            ...
            <select name="nationality" value="<?= $nationality ?>" id="countries">
            ...
            <div class="control">
                ...
                <div class="form_control">
                    ...
                    <input type="file" name="passport" id="nric" value="<?= $passport ?>">
                </div>
            ...
            <div class="control">
                <div class="form_control">
                    ...
                    <input type="date" min="1997-01-01" max="2019-12-31" placeholder="dd-mm-yyyy" value="<?= $dob ?>" name="dob" id="dob">
                </div>
                <div class="form_control">
            ...
            <div class="control">
                <a href="manage-users.php" class="btn-lg">Cancel</a>
                <button type="Submit" name="submit" class="btn-lg"> Sign Up</button>
            </div>
