        ...
        <main>
            ...
            <div class="control">
                <div class="form_control">
                    <a href="add-user.php" class="btn-lg">Register Student</a>
                </div>
                <div class="form_control">
                    <a href="all-student-data.php" class="btn-lg">View all Student Data</a>
                </div>
    ...
    <section class="form_section edit-form">
        <div class="container form_section-container">
            ...
            <form enctype="multipart/form-data" method="POST">
                ...
                <input type="hidden" id="prev_passport_nam" name="prev_passport_name" value="" placeholder="prev Passport">
                ...
                <div class="control">
                <select name="nationality" id="countries">
                ...
                <div class="form_control">
                    ...
                    <input type="file" value="" name="passport" id="nric">
                </div>
