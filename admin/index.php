...
<section class="dashboard">
    ...
    <div class="container dashboard_container">
        ...
        <main id="user">
            ...
            <button id="<?= $user['id'] ?>" class="btn btn-primary btn-edit ">Edit</button>
        </main>
    </div>
</section>
...
<div id="modal-edit">
    <section class="form_section edit-form">
        <div class="container form_section-container">
            ...
            <form enctype="multipart/form-data" method="POST" class="dashboard mt-1">
                <input type="hidden" id="userid" name="id" value="">
                <input type="hidden" id="prevavatar" name="prev_avatar_name" placeholder="prev Avatar">
                <input type="hidden" id="prevpassword" name="prev_password" placeholder="Create New Password">
                <input type="hidden" id="nricpassport" name="prev_nricpassport" >


                <input type="text" id="userfname" name="fname" placeholder="First Name">
                <input type="text" id="userlname" name="lname" placeholder="First Name">
                <input type="text" id="pno" name="pnumber" placeholder="NRIC/Passport Number:">
                <div class="control">
                ...
                <div class="control">
                    ...
                    <?php if ($_SESSION['user_is_admin'] == 0) : ?>
                        <div class="form_control">
                            ...
                            <input type="date" min="1997-01-01" max="2019-12-31" placeholder="dd-mm-yyyy" name="dob" id="dobs">
                        </div>
                    <?php endif  ?>
                ...
                <?php // if ($_SESSION['user_is_admin'] == 0) : ?>
                    <!-- <div class="form_control">
                        ...
                        <input type="file" name="passport" id="nric">
                    </div> -->
                <?php // endif  ?>
...
<?php else : ?>
<script src="../js/edit-admin-profile.js"></script>
<?php endif ?>
<?php
