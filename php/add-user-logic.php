        ...
        if ($createpsword !== $confirmpsword) {
            ...
            if (mysqli_num_rows($user_check_result) > 0 || mysqli_num_rows($admincheck_result) > 0) {
                ...
                if (in_array($img_ext, $passport_format)) {
                        ...
                        if(isset($_FILES['avatar'])){
                            ...
                            if (in_array($image_ext, $image_format)) {
                                ...
                                if ($avatar['size'] < 1000000) {
                                    ...
                                    $_SESSION['signup'] = "Avatar File size too big. should be less than 1mb";
                                }
                            } else {
                                $_SESSION['signup'] = "Avatar File should be png, jpg, or jpeg";
                    ...
                    $_SESSION['signup'] = "Passport File should be png, jpg, or jpeg";
                }
            }
        }
    }
